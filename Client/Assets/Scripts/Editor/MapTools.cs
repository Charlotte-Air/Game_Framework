...
public class MapTools
{
    ...
    public static void ExportTeleporters()
    {
        ...
        {
            string sceneFile = "Assets/Scene/" + map.Value.Resource + ".unity"; //根据地图名生成原始路径
        ...
        EditorSceneManager.OpenScene("X:/Game_Framework/Client/Assets/Scene/" + currentScene + ".unity");
